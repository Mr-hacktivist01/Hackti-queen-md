...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || '𝑯𝑨𝑪𝑲𝑻𝑰-𝑸𝑼𝑬𝑬𝑵-𝑴𝑫;Hacktivist;0;https://i.ibb.co/Ph9T4vK/logo.jpg;https://chat.whatsapp.com/Imi0xFyoBmIBUSc7C947TL',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'on',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA,
    BOT_NAME: process.env.BOT_NAME || '𝐐𝐔𝐄𝐄𝐍-𝐌𝐃 𝐁𝐎𝐓',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ꪶꪶ͢٭𝑯𝑨𝑪𝑲𝑻𝑰𝑽𝑰𝑺𝑻ꫂ;Hackti queen md;https://i.ibb.co/Ph9T4vK/logo.jpg' : process.env.AUDIO_DATA,
